...
- Testy: 47 jednostkowych (`npm test`), E2E Playwright na emulowanym Pixelu 7 (`npm run e2e`).
- Audyt przed publikacją (09.2026): naprawione m.in. czarny ekran pierwszej rundy w WebView, zamrożone
  ...
  przy pierwszym uruchomieniu (cały stos reklamowy — zgoda, SDK, pomiar — rusza dopiero po samouczku).
