...
- Testy: 46 jednostkowych (`npm test`), E2E Playwright na emulowanym Pixelu 7 (`npm run e2e`).
- Audyt przed publikacją (09.2026): naprawione m.in. czarny ekran pierwszej rundy w WebView, zamrożone
  ...
  na telefonach 360 dp, `singleTask` zamykający reklamy, cisza nocna dla powiadomień.
