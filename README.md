...
2. Poczekaj na synchronizację Gradle. Jeśli Android Studio zaproponuje aktualizację AGP/Kotlin/bibliotek —
   możesz ją przyjąć (projekt: AGP 9.3 z wbudowanym Kotlinem, Gradle 9.5, compileSdk/targetSdk 36, minSdk 26;
   wymaga Android Studio Quail 2 | 2026.1.2 lub nowszego).
...
## Testy i narzędzia
```bash
npm test                 # 47 testów jednostkowych: rdzeń, zapis, meta-progresja, symulacja
